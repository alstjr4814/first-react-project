        ...
        <Routes>
            ...
            <Route path="/sub/*" element={
                <Routes>
                    ...
                    <Route path="/address1" element={<h1>주소2</h1>} />
                    </Routes>
                    } />
...
function Phone() {
    return <div>
        ...
        <Routes>
            <Route path="/p1" element={<h3>010-1234-5678</h3>}/>
            <Route path="/p2" element={<h3>010-3425-1632</h3>}/>
            <Route path="/p3" element={<h3>010-1124-5678</h3>}/>
            <Route path="/*" element={<NotFound />} />
        </Routes>
    </div>
}
